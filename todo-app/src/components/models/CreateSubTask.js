...
import { createSubTask } from '../../services/taskSerivce';
            ...
            <div style={modalStyles}>
                <div style={modalContainerStyle}>
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                        <div style={{ fontSize: 30, color: defaultStyles.colors.dark }}>Create&nbsp;Sub&nbsp;Task</div>
                        <div className="createTask" onClick={this.props.onCancel} style={{ marginLeft: '60%' }}>
                            <Icon name="Cancel" size="40"/>
                        </div>
                    </div>
                    {this.state.loading && <div style={{ color: 'green', marginLeft: '40%' }}>Creating...</div>}
